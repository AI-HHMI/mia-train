...
class DinoVisionTransformer(BaseModel):
    ...
    def tensor_parallel_plan(self) -> dict[str, ParallelStyle] | None:
        ...
        Identical to the 3D encoder's, because the stack is identical; see
        `distributed.tensor_parallel.self_attention_stack_plan` for what it covers and what it
        deliberately leaves replicated.
        """
